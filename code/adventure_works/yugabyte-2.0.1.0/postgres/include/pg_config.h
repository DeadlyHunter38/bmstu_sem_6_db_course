...
#define PG_VERSION "11.2-YB-2.0.1.0-b0"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 110002

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 11.2-YB-2.0.1.0-b0 on x86_64-apple-darwin18.0.0, compiled by Apple LLVM version 10.0.0 (clang-1000.10.44.4), 64-bit"
